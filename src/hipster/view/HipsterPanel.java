...
public class HipsterPanel extends JPanel
{
	...
	public HipsterPanel(HipsterController baseController)
	{
		...
		imageURL = getClass().getResource("/hipster/view/images/Hipster Vegeta.jpg");
...
//		booksArea.append("\n This Hipster has " + currentHipster.getHipsterBooks().length + " books.");
//		booksArea.append("\n" + currentHipster.alphabetizeBooks(currentHipster.getHipsterBooks()));
		imageURL = getClass().getResource("/hipster/view/images/" + currentHipster.getName() + ".jpg");
		
		if (imageURL.toString().contains(currentHipster.getName()))
		{
	...
	private String[] getNamesForComboBox()
	{
		...
		{
			tempNames[realSize] = baseController.getCubbyHipsters()[realSize]
					.getName();
		}
